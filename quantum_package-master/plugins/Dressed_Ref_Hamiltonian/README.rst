...
`dressing_ref_hamiltonian <http://github.com/LCPQ/quantum_package/tree/master/plugins/Dressed_Ref_Hamiltonian/dressed_hamiltonian.irp.f#L1>`_
  Undocumented


`hamiltonian_total_dressed <http://github.com/LCPQ/quantum_package/tree/master/plugins/Dressed_Ref_Hamiltonian/dressed_hamiltonian.irp.f#L64>`_
  Undocumented

...
subroutine routine
 ...
 do i = 1, ionic_index(1,0)  ! number of determinants in the ref wf that are neutrals
  n_det_ref_determinants_save +=1
  index_ref_determinants_save(n_det_ref_determinants_save) = ionic_index(1,i)
 enddo
 ...
 do i = 1, n_det_non_ref_determinants_save ! set the non ref determinants to psi_save_final
  ...
  enddo
  psi_coef_save_final(n_det_tmp,1) = psi_non_ref_coef(index_non_ref_determinants_save(i),1)
 enddo

...
`psi_selectors_ab <http://github.com/LCPQ/quantum_package/tree/master/plugins/Selectors_no_sorted/selectors.irp.f#L60>`_
  Determinants on which we apply <i|H|j>.
  They are sorted by the 3 highest electrons in the alpha part,
  then by the 3 highest electrons in the beta part to accelerate
  the research of connected determinants.
...
`psi_selectors_coef_ab <http://github.com/LCPQ/quantum_package/tree/master/plugins/Selectors_no_sorted/selectors.irp.f#L61>`_
  Determinants on which we apply <i|H|j>.
  They are sorted by the 3 highest electrons in the alpha part,
  then by the 3 highest electrons in the beta part to accelerate
  the research of connected determinants.
...
`psi_selectors_next_ab <http://github.com/LCPQ/quantum_package/tree/master/plugins/Selectors_no_sorted/selectors.irp.f#L62>`_
  Determinants on which we apply <i|H|j>.
  They are sorted by the 3 highest electrons in the alpha part,
  then by the 3 highest electrons in the beta part to accelerate
  the research of connected determinants.

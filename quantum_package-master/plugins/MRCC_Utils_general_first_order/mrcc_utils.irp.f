...
&BEGIN_PROVIDER [ double precision, delta_ij_ref, (N_det_ref, N_det_ref,N_states) ]
&BEGIN_PROVIDER [ double precision, delta_ii, (N_det_ref,N_states) ]
 ...
 delta_ij_ref = 0.d0
 delta_ii = 0.d0
 call H_apply_mrcc(delta_ij,delta_ii,delta_ij_ref,N_det_ref,N_det_non_ref)
 ...
 if(imax .gt. 1 .and. jmax .gt. 1)then
 ...
 do i = 1, N_det_ref
  ...
  print*,'delta_ij(i,i)     = ',delta_ij_ref(i,i,1)
  print*,''
 enddo
END_PROVIDER

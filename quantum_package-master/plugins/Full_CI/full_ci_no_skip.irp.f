program full_ci
  ...
  double precision :: E_CI_before(N_states),pt2_before(N_states)
  if(read_wf)then
  ...
  do while (N_det < N_det_max.and.maxval(abs(pt2(1:N_st))) > pt2_max)
    ...
    print *,  'N_det    = ', N_det
    print *,  'N_states = ', N_states
    print *,  'PT2      = ', pt2_before
    print *,  'E        = ', CI_energy
    print *,  'E+PT2    = ', E_CI_before+pt2
    print *,  'H_pert_diag',  H_pert_diag
    print *,  '-----'
    write(33,'(I8,X,4(F16.8))')N_det,CI_energy,E_CI_before+pt2,pt2_before,H_pert_diag
    E_CI_before = CI_energy
    pt2_before = pt2
...
!   print*,'The thres'
    ...
    print *,  'E+PT2    = ', CI_energy+pt2
    print *,  'H_pert_diag',  H_pert_diag
    write(33,'(I8,X,4(F16.8))')N_det,CI_energy,CI_energy+pt2,pt2,H_pert_diag
    print *,  '-----'

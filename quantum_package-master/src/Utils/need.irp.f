      ...
      arg=gamtot*u*u-gamA*A(l)*gamA*A(l)-gamB*B(l)*gamB*B(l)
      alpha=dexp(arg)
...
! <fortran>
      ...
      implicit double precision (a-h,o-z)
      if(x.lt.0.d0.or.a.le.0.d0)stop 'error in gammp'
      if(x.lt.a+1.d0)then
...
! <fortran>
      ...
      implicit double precision (a-h,o-z)
      parameter (itmax=200,eps=3.e-16)
      gln=gammln(a)
      if(x.le.0.d0)then

...
BEGIN_PROVIDER [ logical, mo_bielec_integrals_in_map ]
  ...
  print*,'read_mo_integrals = ',read_mo_integrals
  if (read_mo_integrals) then
    integer                        :: load_mo_integrals
    print*,'Reading the MO integrals'
!   print*,load_mo_integrals(trim(ezfio_filename)//'/work/mo_integrals.bin')
...
IRP_ENDIF
  ...
  print*,'Writing the MO bielec integrals ?'
  print*,'write_mo_integrals = ',write_mo_integrals
  print*,"disk_access_mo_integrals.EQ.'Write'", disk_access_mo_integrals.EQ.'Write'

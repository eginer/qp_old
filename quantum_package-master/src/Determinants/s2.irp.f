...
!        double precision :: phase_2
!        call get_double_excitation(key_i,key_j,exc,phase_2,Nint)
!        if(phase_spsm * phase_2 .lt.0.d0)then
!         print*,'PB !!'
!        endif
         s2 =  -phase_spsm
!        s2 =  phase_spsm
...
subroutine get_uJ_s2_uI(psi_keys_tmp,psi_coefs_tmp,n,nmax_coefs,nmax_keys,s2,nstates)
 ...
 print*,'n,nmax_coefs,nmax_keys,nstates'
 print*, n,nmax_coefs,nmax_keys,nstates 
 s2 = 0.d0
 do ll = 1, nstates
  do jj = 1, nstates 
...
!subroutine diagonalize_s2_betweenstates(keys_tmp,psi_coefs_inout,ndets_real,ndets_keys,ndets_coefs,nstates)
...
subroutine get_s2_u0(psi_keys_tmp,psi_coefs_tmp,n,nmax,s2)
  ...
  double precision               :: threshold_davidson_bis
  
  allocate (shortcut(0:n+1), sort_idx(n), sorted(N_int,n), version(N_int,n))
  s2 = 0.d0
  threshold_davidson_bis = threshold_davidson
